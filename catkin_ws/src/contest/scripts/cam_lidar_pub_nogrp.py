...
class Sensor:
    ...
    def traffic_light(self, img) :
        ...
        blue_lower = np.array([106, 220, 160])
        blue_upper = np.array([107,255,220])
    ...
    def img_CB(self,data):
        ...
        crop_traffic_img = img.copy()[90:270, 440:640]
    ...
    def lidar_callback(self, msg):
        # start = time.time()
        self.scan_msg = msg
        self.filtering(self.lidar_range[0], self.lidar_range[-1], self.lidar_dist)
        # print(self.objects_pub)
        self.obj_pub.publish(self.objects_pub)
        self.objects_pub.no_objects = 0
        # end = time.time()
    ...
    def filtering(self, right_angle, left_angle, distance):
        ...
        for index in range(right_angle, left_angle + 1):
                if self.scan_msg.ranges[index] < distance:
                    self.objects_pub.no_objects = 1
                    # self.objects_pub.object.dist = 
                # print(obstacles)
